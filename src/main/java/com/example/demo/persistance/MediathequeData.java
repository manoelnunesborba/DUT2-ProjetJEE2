...
// Jean-Fran�ois Brette 01/01/2018
	...
	try {
		//Class.forName("com.mysql.cj.jdbc.Driver"); SI CA NE MARCHE PAS, COMMENTEZ LA LIGNE EN DESSOUS ET DECOMMENTEZ CELLE Là
	...
	public void ajoutDocument(int type, Object... args) {
		synchronized (this){
			...
			try {
				...
				stmt.setInt(2, type);
				stmt.setString(3, String.valueOf(args[1]));
				stmt.setString(4, String.valueOf(args[2]));
				stmt.setString(5, jo.toString());
				stmt.executeUpdate();
				c.close();
			} catch (SQLException e) {
				e.printStackTrace();
